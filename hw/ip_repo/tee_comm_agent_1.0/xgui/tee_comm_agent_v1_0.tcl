...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S_TEE_ARGS_NMR"

}

proc update_PARAM_VALUE.C_S_TEE_ARGS_NMR { PARAM_VALUE.C_S_TEE_ARGS_NMR } {
	# Procedure called to update C_S_TEE_ARGS_NMR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S_TEE_ARGS_NMR { PARAM_VALUE.C_S_TEE_ARGS_NMR } {
	# Procedure called to validate C_S_TEE_ARGS_NMR
	return true
}
...
proc update_MODELPARAM_VALUE.C_S_TEE_ARGS_NMR { MODELPARAM_VALUE.C_S_TEE_ARGS_NMR PARAM_VALUE.C_S_TEE_ARGS_NMR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S_TEE_ARGS_NMR}] ${MODELPARAM_VALUE.C_S_TEE_ARGS_NMR}
}
