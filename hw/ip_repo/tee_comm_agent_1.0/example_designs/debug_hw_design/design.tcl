...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: tee_comm_agent_0, and set properties
	set tee_comm_agent_0 [ create_bd_cell -type ip -vlnv user.org:user:tee_comm_agent:1.0 tee_comm_agent_0 ]
	...
	# Connect all clock & reset of tee_comm_agent_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins tee_comm_agent_0/S00_AXI]
	connect_bd_net [get_bd_pins tee_comm_agent_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins tee_comm_agent_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins tee_comm_agent_0/S01_AXI]
	connect_bd_net [get_bd_pins tee_comm_agent_0/s01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins tee_comm_agent_0/s01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to tee_comm_agent_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/tee_comm_agent_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_tee_comm_agent_0_S00_AXI_* ]]
	puts $fp "set s00_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_tee_comm_agent_0_S01_AXI_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:tee_comm_agent:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/tee_comm_agent_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "tee_comm_agent_v1_0_hw_${i}"
